...
<section class="content-header">
	...
	<div class="main_btn ta_r">
		...
		<button class="button searchBtn" id="btn_Search">
			<span>조회</span>
		</button>
		<button class="button selectBtn" id="btn_Select">
			<span>선택</span>
		</button>
		<button class="button insertBtn" id="btn_Insert">
			<span>추가</span>
		</button>
		<button class="button saveBtn" id="btn_Save">
			<span>저장</span>
		</button>
		<button class="button deleteBtn" id="btn_Delete">
			<span>삭제</span>
		</button>
		<button class="button excelBtn" id="btn_Excel">
			<span>엑셀</span>
		</button>
		<button class="button excelBtn" id="btn_ExcelMca">
			<span>축경통 자료</span>
		</button>
		<button class="button excelBtn" id="btn_ExcelData">
			<span>엑셀자료</span>
		</button>
		<button class="button printBtn" id="btn_Print">
			<span>인쇄</span>
		</button>
		<button class="button closeBtn" id="btn_Close">
			<span>닫기</span>
		</button>
	</div>
</section>
<script>
	...
	$(document).ready(function() {
		...
		$("#btn_ExcelMca").click(function(event) {
			event.preventDefault();
			this.blur();
			if (auth_btn.AUTH_X == "1") {
				fn_ExcelMca();
		...
		$("#btn_ExcelData").click(function(event) {
			event.preventDefault();
			this.blur();
			if (auth_btn.AUTH_X == "1") {
				fn_ExcelData();
