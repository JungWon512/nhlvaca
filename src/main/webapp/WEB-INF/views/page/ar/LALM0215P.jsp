        ...
        <div class="sec_table">
            <div class="blueTable rsp_v">
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <th><span class="tb_dot">우상인명</span></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){      
        ...
        $("#grd_MmFhs").jqGrid("hideCol","DEL_YN");
    ...
    function fn_Search(){   
        ...
        //정합성체크        
        var results = sendAjaxFrm("frm_Search", "/LALM0215P_selList", "POST");        
        var result;
    ...
    function fn_CreateGrid(data){              
        ...
        var searchResultColNames = ["우상인코드", "우상인명", "우상인관리번호", "우상인식별번호","우편번호","동이상주소","동이하주소","자택전화번호","휴대폰 번호","조합원여부","관내외<br>구분코드", "삭제여부", "경제통합거래처코드", "비고" ];        
        var searchResultColModel = [
						            {name:"FHS_ID_NO"  , index:"FHS_ID_NO"     , width:80,  align:'center'},
						            {name:"FTSNM"      , index:"FTSNM"         , width:80,  align:'center'},
						            {name:"FARM_AMNNO" , index:"FARM_AMNNO"    , width:90,  align:'center'},
						            {name:"FARM_ID_NO" , index:"FARM_ID_NO"    , width:90,  align:'center'},
						            ...
						            {name:"NA_TRPL_C"  , index:"NA_TRPL_C"     , width:160, align:'center'},
						            {name:"RMK_CNTN"   , index:"RMK_CNTN"      , width:70,  align:'center'},
