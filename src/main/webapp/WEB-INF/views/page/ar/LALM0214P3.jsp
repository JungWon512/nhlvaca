...
<script type="text/javascript">
    ...
    function fn_CreateGrid(data){              
        ...
        var searchResultColModel = [
                                     ...
                                     {name:"TD_RC_CST",            index:"TD_RC_CST",            width:70,  align:'center', sortable : false, editable:true , formatter:'integer'},
                                     {name:"BOVINE_DT",            index:"BOVINE_DT",              width:90,  align:'left'  , sortable : false, editable:true ,formatter:'gridDateFormat'},
                                     {name:"BOVINE_RSLTNM",        index:"BOVINE_RSLTNM",                width:80,  align:'center', sortable : false, editable:true },
                                     {name:"VACN_DT",              index:"VACN_DT",              width:90,  align:'left'  , sortable : false, editable:true ,formatter:'gridDateFormat'},
