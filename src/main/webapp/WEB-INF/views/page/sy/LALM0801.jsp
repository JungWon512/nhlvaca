...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        fn_CreateGrid();  
        fn_setCodeBox("blbd_dsc", "BLBD_DSC", 3, true); 
        fn_Init();
    });    
    ...
    function fn_CreateGrid(data){              
        ...
        var searchResultColModel = [
        	                         ...
        	                         {name:"BLBD_DSC",         index:"BLBD_DSC",     width:80, align:'center', edittype:"select", formatter : "select", editoptions:{value:fn_setCodeString("BLBD_DSC", 3)}},
