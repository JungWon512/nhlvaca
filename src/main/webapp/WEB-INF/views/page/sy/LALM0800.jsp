...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        fn_CreateGrid();  
        fn_setCodeBox("blbd_dsc", "BLBD_DSC", 2, true,'전체'); 
        fn_Init();
    });    
    ...
    function fn_Init(){        
        ...
        $('#blbd_dsc').val($( "#blbd_dsc option:first").val()).prop("selected",true);
    ...
    function fn_CreateGrid(data){              
        ...
        if(data != null){
       	...
       	var searchResultColNames = ["H사업장코드","게시판구분","H댓글번호","고정여부","게시글번호","제목", "등록자","등록일","조회건수"];        
        var searchResultColModel = [
        	                         {name:"NA_BZPLC",         index:"NA_BZPLC",     width:80, align:'center',hidden:true},
        	                         {name:"BLBD_DSC",         index:"BLBD_DSC",     width:80, align:'center', edittype:"select", formatter : "select", editoptions:{value:fn_setCodeString("BLBD_DSC", 1)}},
            ...
            <div class="sec_table">
                <div class="blueTable rsp_v">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">게시판구분<strong class="req_dot">*</strong></th>
                                <td>
