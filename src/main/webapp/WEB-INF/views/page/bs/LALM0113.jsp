...
<script type="text/javascript">
    ...
    function fn_CreateGrd_MmMwmn(data){
        ...
        var searchResultColNames = ["경제통합거래처코드","중도매인코드","중도매인명","생년월일","생년월일/사업자<br> 번호","경제통합거래처"
    ...
    <div class="contents">
        ...
        <section class="content">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="sr_sra_mwmnnm"  maxlength="30" >                                        
                                </td>
                                <td></td>
                            </tr>
                        </tbody>
            ...
            <div class="tab_box clearfix">
                ...
                <div class="pl2 fl_L"><!--  //버튼 모두 우측정렬 -->
                     <label id="msg_Sbid" style="font-size:15px;color: blue;font: message-box;">※ 필수입력사항 : 생년 월일/사업자 번호(숫자만 입력 가능), 주소, 휴대폰</label>   
                </div>
	                    ...
	                    <table>
	                        ...
	                        <tbody>
	                            <tr>
	                                ...
	                                <td>
	                                    <input type="text" id="trmn_amnno" disabled="disabled"/>
	                                </td>
	                                <th scope="row">중도매인명<strong class="req_dot">*</strong></th>
                                    <td>
                                        <input type="text" id="sra_mwmnnm" class="popup"/>
                                    </td>
	                            ...
	                            <tr>
                                    ...
                                    <td colspan="2">
<!--                                         <input type="text" id="dongup" disabled="disabled"/> -->
                                        <input type="text" id="dongup"/>
                                    </td>
                                    <td colspan="2">
                                        <input type="text" id="dongbw"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="cellBox v_addr">
                                            ...
                                            <div class="cell pl2" style="width:26px;">
                                                <button id="pb_SearchTrpl" class="tb_btn white srch"><i class="fa fa-search"></i></button>
                                            </div>
                                    ...
                                    <td>
                                        <input type="text" id="ohse_telno"/>
                                    </td>
                                    <th scope="row">휴대폰</th>
                                    <td>
                                        <input type="text" id="cus_mpno" class="digit" maxlength="14"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">조합원</th>
                                    <td>
                                        <div class="cellBox" id="rd_maco_yn">
	                                        <div class="cell">
	                                            <input type="radio" id="maco_yn_0" name="maco_yn_radio" value="0" 
	                                            onclick="javascript:fn_setChgRadio('maco_yn','0');"/>
	                                            <label>비조합원</label>
	                                            <input type="radio" id="maco_yn_1" name="maco_yn_radio" value="1" 
	                                            onclick="javascript:fn_setChgRadio('maco_yn','1');"/>
	                                            <label>조합원</label>
	                                        </div>
	                                    </div>
                                    ...
                                    <td>
                                        <div class="cellBox" id="rd_jrdwo_dsc">
	                                        <div class="cell">
	                                            <input type="radio" id="jrdwo_dsc_1" name="jrdwo_dsc_radio" value="1" 
	                                            onclick="javascript:fn_setChgRadio('jrdwo_dsc','1');"/>
	                                            <label>관내</label>
	                                            <input type="radio" id="jrdwo_dsc_2" name="jrdwo_dsc_radio" value="2" 
	                                            onclick="javascript:fn_setChgRadio('jrdwo_dsc','2');"/>
	                                            <label>관외</label>
	                                        </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="cellBox" id="rd_psn_inf_ofr_agr_yn">
                                            <div class="cell">
                                                <input type="radio" id="psn_inf_ofr_agr_yn_0" name="psn_inf_ofr_agr_yn_radio" value="0" 
                                                onclick="javascript:fn_setChgRadio('psn_inf_ofr_agr_yn','0');"/>
                                                <label>미동의</label>
                                                <input type="radio" id="psn_inf_ofr_agr_yn_1" name="psn_inf_ofr_agr_yn_radio" value="1" 
                                                onclick="javascript:fn_setChgRadio('psn_inf_ofr_agr_yn','1');"/>
                                                <label>동의</label>
                                            </div>
                                        </div>
                                        <input type="hidden" id="psn_inf_ofr_agr_yn"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">비고</th>
            ...
            <div class="tab_box clearfix">
                ...
                <div class="pl2 fl_L"><!--  //버튼 모두 우측정렬 -->
                     <label id="msg_Sbid" style="font-size:15px;color: blue;font: message-box;">※ 입력하신 내용(생년월일/사업자번호)과 다를경우 시스템관리자에게 문의해주세요.</label>
