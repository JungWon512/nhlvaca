    	 ...
    	 MessagePopup('YESNO',"저장 하시겠습니까?",function(res){
             if(res){
            	 ...
            	 var tmpSaveObject = $.grep($("#mainGrid").jqGrid('getRowData'), function(obj){
            		return obj._STATUS_ == "*" && obj.LVST_AUC_PTC_MN_NO && obj.TRMN_AMNNO && obj.SRA_MWMNNM;
            	 });
...
// 	    }
    ...
    function fn_CreateGrid(data){              
	        ...
	        var searchResultColNames = ["", "경매대상", "경매번호", "귀표번호", "생년월일", "성별", "KPN", "계대", "산차", "어미귀표번호", "어미구분", "중량", "예정가", "코드", "번호", "성명", "", "입찰가", "경매일자", "원표번호"];      
