  ...
  ------------------------------------------------------------------------------*/
    ...
    function fn_CreateViewGrid(data){
		...
		var searchResultColModel = [
                                    ...
                                    {name:"SRA_SBID_AM",               index:"SRA_SBID_AM",               width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                    {name:"SRA_SEL_FEE",               index:"SRA_SEL_FEE",               width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                    {name:"SRA_ETC_CST",               index:"SRA_ETC_CST",               width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                    {name:"AUC_ENTR_GRN_AM",           index:"AUC_ENTR_GRN_AM",           width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                    {name:"IO_AM_15",                  index:"IO_AM_15",                  width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                    {name:"SRA_RV_AM",                 index:"SRA_RV_AM",                 width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                    {name:"NOTPAY",                    index:"NOTPAY",                    width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}}
                                    ];
    ...
    function fn_CreateGrid(data){
		...
		var searchResultColModel = [
                                    ...
                                    {name:"SRA_ETC_CST",               index:"SRA_ETC_CST",               width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                    {name:"AUC_ENTR_GRN_AM",           index:"AUC_ENTR_GRN_AM",           width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
        /*정산금액*/                {name:"IO_AM_15",                  index:"IO_AM_15",                  width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
        /*입금액*/                  {name:"SRA_RV_AM",                 index:"SRA_RV_AM",                 width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
        /*미납입*/                  {name:"NOTPAY",                    index:"NOTPAY",                    width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}}
                                    ];
...
//         	dataItem['NOTPAY'] 			= l_NOTPAY;
	...
	function fn_CreateGrid_2(data){
        ...
        var searchResultColModel = [
                                     ...
                                     {name:"COW_SOG_WT",                index:"COW_SOG_WT",               width:100, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     ...
                                     {name:"FEE_AM",                    index:"FEE_AM",                   width:100, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}}
                                     ];
	...
	function fn_CreateGrid_3(data){
        ...
        var searchResultColNames = ["경매일자", "경매번호", "주소", "출하자코드", "출하자명", "귀표번호", "생년월일", "산차", "어미구분", "계대", "전화번호", "아비KPN", "성별", "중량(Kg)", 
        							"응찰하한가", "낙찰단가", "낙찰가", "수송자", "진행상태", "낙찰자", "응찰번호"];        
        ...
        var searchResultColModel = [
                                     ...
                                     {name:"LOWS_SBID_LMT_AM",          index:"LOWS_SBID_LMT_AM",         width:80,  align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"SRA_SBID_UPR",              index:"SRA_SBID_UPR",             width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"SRA_SBID_AM",               index:"SRA_SBID_AM",              width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	...
	function fn_CreateGrid_4(data){
        ...
        var searchResultColModel = [
                                     ...
                                     {name:"SRA_AUC_SBID_HDCN",         index:"SRA_AUC_SBID_HDCN",        width:65, align:'center'},
                                     {name:"SRA_SBID_AM",               index:"SRA_SBID_AM",              width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"TOT_FEE",                   index:"TOT_FEE",                  width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"TOT_AM",                    index:"TOT_AM",                   width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"AUC_ENTR_GRN_AM",           index:"AUC_ENTR_GRN_AM",          width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
         							 {name:"CSH_RV_AM",                 index:"CSH_RV_AM",                width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
         							 {name:"CK_RV_AM",                  index:"CK_RV_AM",                 width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"FTR_AM",                    index:"FTR_AM",                   width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"ETC_RV_AM",                 index:"ETC_RV_AM",                width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"SRA_RV_AM",                 index:"SRA_RV_AM",                width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"NPAY_AM",                   index:"NPAY_AM",                  width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
...
function fn_CreateGrid_5(data){
        ...
        var searchResultColNames = ["H기타수수료","h운송비","H출하수수료","H사고적립금","경매대상", "경매번호", "출하자코드", "경제통합 거래처코드", "출하자명", "출하자 생년월일", "주소", "핸드폰", "귀표번호", "진행상태", "성별", 
        							"생년월일", "월령", "중량(Kg)", "응찰하한가", "낙찰단가", "낙찰가격", "수수료", "정산금액", "예금주", "계좌번호", "수송자", "낙찰자수수료", "낙찰자"];        
        ...
        var searchResultColModel = [
         							 ...
         							 {name:"AUC_OBJ_DSC",               index:"AUC_OBJ_DSC",              width:65,  align:'center' , edittype:"select", formatter : "select", editoptions:{value:fn_setCodeString("AUC_OBJ_DSC", 1)}},
                                     {name:"AUC_PRG_SQ",                index:"AUC_PRG_SQ",               width:65,  align:'center'},
                                     ...
                                     {name:"COW_SOG_WT",                index:"COW_SOG_WT",               width:65,  align:'right'},
                                     {name:"LOWS_SBID_LMT_AM",          index:"LOWS_SBID_LMT_AM",         width:75,  align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"SRA_SBID_UPR",              index:"SRA_SBID_UPR",             width:65,  align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"SRA_SBID_AM",               index:"SRA_SBID_AM",              width:65,  align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"FHS_TOT_AM",                index:"FHS_TOT_AM",               width:100, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"TOT_AM",                    index:"TOT_AM",                   width:100, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"ACNO_OWNER",                index:"ACNO_OWNER",               width:100, align:'center'},
                                     {name:"SRA_FARM_ACNO",             index:"SRA_FARM_ACNO",            width:100, align:'center'},
                                     {name:"VHC_DRV_CAFFNM",            index:"VHC_DRV_CAFFNM",           width:100, align:'center'},
                                     {name:"SRA_TR_FEE2",               index:"SRA_TR_FEE2",              width:100, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                     {name:"SRA_MWMNNM",                index:"SRA_MWMNNM",               width:100, align:'center'}
...
function fn_CreateSubGrid_5(data){
    ...
    var searchResultColNames = ["경매대상","경매번호","출하자코드","경제통합 거래처코드","출하자명", "주소", "핸드폰", "귀표번호", "진행상태", "성별", "생년월일", "월령", "중량(Kg)", "응찰하한가", "낙찰단가", 
    ...
    var searchResultColModel = [
                                 ...
                                 {name:"LOWS_SBID_LMT_AM",  index:"LOWS_SBID_LMT_AM",   width:120,  align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                 {name:"SRA_SBID_UPR",      index:"SRA_SBID_UPR",       width:120,  align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                 {name:"SRA_SBID_AM",       index:"SRA_SBID_AM",        width:120,  align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                 {name:"FHS_TOT_AM",        index:"FHS_TOT_AM",         width:120,  align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                 {name:"TOT_AM",            index:"TOT_AM",             width:120,  align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
                                 {name:"ACNO_OWNER",        index:"ACNO_OWNER",         width:100,  align:'center'},
	...
	function fn_CreateGrid_6(data){
	    ...
	    var searchResultColModel = [
	                                 ...
	                                 {name:"SRA_SBID_UPR",              index:"SRA_SBID_UPR",             width:100, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_SBID_AM",               index:"SRA_SBID_AM",              width:100, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"TOT_FEE",                   index:"TOT_FEE",                  width:100, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SBT_PY_AM",                 index:"SBT_PY_AM",                width:100, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	...
	function fn_CreateGrid_7(data){
	    ...
	    var searchResultColModel = [
	                                 ...
	                                 {name:"TRPCS",                     index:"TRPCS",                    width:200, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}}
	                                 ];
	...
	function fn_CreateGrid_8(data){
	    ...
	    var searchResultColNames = ["등록구분", "성별", "두수", "전체(Kg)", "평균(Kg)", "총 응찰하한가", "응찰하한가 평균금액(A)",
	    ...
	    var searchResultColModel = [
	                                 ...
	                                 {name:"INDV_SEX_C",                index:"INDV_SEX_C",               width:80,  align:'center', edittype:"select", formatter : "select", editoptions:{value:fn_setCodeString("INDV_SEX_C", 1)}},
	                                 {name:"TOT_HDCN",                  index:"TOT_HDCN",                 width:60,  align:'center'},
	                                 {name:"TOT_WT",                    index:"TOT_WT",                   width:80,  align:'right'},
	                                 {name:"AVG_WT",                    index:"AVG_WT",                   width:80,  align:'right'},
	                                 {name:"LOWS_SBID_LMT_AM",          index:"LOWS_SBID_LMT_AM",         width:150, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"AVG_PR",                    index:"AVG_PR",                   width:150, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_SBID_AM",               index:"SRA_SBID_AM",              width:150, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_AVG_SBID_UPR",          index:"SRA_AVG_SBID_UPR",         width:150, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"BIGO",                      index:"BIGO",                     width:150, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}}
	                               ];
	...
	function fn_CreateGrid_9(data){
	    ...
	    var searchResultColModel = [
	                                 ...
	                                 {name:"TOT_FEE",                   index:"TOT_FEE",                  width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"AUC_ENTR_GRN_AM",           index:"AUC_ENTR_GRN_AM",          width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"ACRV_AM",                   index:"ACRV_AM",                  width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_RV_AM",                 index:"SRA_RV_AM",                width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"IO_NPAY_AM19",              index:"IO_NPAY_AM19",             width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"TOT_SOG_AM",                index:"TOT_SOG_AM",               width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"YU_FHS_TOT",                index:"YU_FHS_TOT",               width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 ...
	                                 {name:"IO_FEME_SRA_SBID_AM",       index:"IO_FEME_SRA_SBID_AM",      width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"IO_MALE_SRA_SBID_AM",       index:"IO_MALE_SRA_SBID_AM",      width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_FEE",                   index:"SRA_FEE",                  width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"IO_SRA_FEE18",              index:"IO_SRA_FEE18",             width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_TR_FEE",                index:"SRA_TR_FEE",               width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"IO_SRA_FEE19",              index:"IO_SRA_FEE19",             width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_ETC_CST",               index:"SRA_ETC_CST",              width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"IO_SRA_FEE20",              index:"IO_SRA_FEE20",             width:90, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}}
	                               ];
	...
	function fn_CreateGrid_10(data){
	    ...
	    var searchResultColModel = [
	                                 ...
	                                 {name:"AUC_PRG_SQ",                index:"AUC_PRG_SQ",             width:85, align:'center'},
	                                 ...
	                                 {name:"AUC_ENTR_GRN_AM",           index:"AUC_ENTR_GRN_AM",        width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 ...
	                                 {name:"SRA_SBID_AM",               index:"SRA_SBID_AM",            width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_SOG_FEE",               index:"SRA_SOG_FEE",            width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_SEL_FEE",               index:"SRA_SEL_FEE",            width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_ACO_IVSAM",             index:"SRA_ACO_IVSAM",          width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_ACD_RVGAM",             index:"SRA_ACD_RVGAM",          width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_TRPCS",                 index:"SRA_TRPCS",              width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_NCSS_JUG_FEE",          index:"SRA_NCSS_JUG_FEE",       width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_PRNY_JUG_FEE",          index:"SRA_PRNY_JUG_FEE",       width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_MDCCS",                 index:"SRA_MDCCS",              width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_INJT_FEE",              index:"SRA_INJT_FEE",           width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_SHNM",                  index:"SRA_SHNM",               width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_PDG_RC_FEE",            index:"SRA_PDG_RC_FEE",         width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_RMHN_FEE",              index:"SRA_RMHN_FEE",           width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_TRU_FEE",               index:"SRA_TRU_FEE",            width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"IO_AM_15",                  index:"IO_AM_15",               width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_RV_AM",                 index:"SRA_RV_AM",              width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"IO_AM_151",                 index:"IO_AM_151",              width:85, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}}
	                               ];
...
//         	dataItem['IO_AM_151']		= l_IO_AM_151;
	...
	function fn_CreateGrid_11(data){
	    ...
	    var searchResultColNames = ["H경매일자","H수수료",
	    							"경매번호", "출하자코드", "출하자명", "주소", "귀표번호", "(송)귀표번호", "성별","KPN", "응찰하한가", "중량(Kg)", "낙찰단가", "낙찰가격", "출하수수료", "출자금", 
	    ...
	    var searchResultColModel = [
	                                 ...
	                                 {name:"LOWS_SBID_LMT_AM",		index:"LOWS_SBID_LMT_AM",			width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"COW_SOG_WT",			index:"COW_SOG_WT",					width:65,  align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_SBID_UPR",			index:"SRA_SBID_UPR",				width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_SBID_AM",			index:"SRA_SBID_AM",				width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_SOG_FEE",			index:"SRA_SOG_FEE",				width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_PYIVA",				index:"SRA_PYIVA",					width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_ACD_RVGAM",			index:"SRA_ACD_RVGAM",				width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_TRPCS",				index:"SRA_TRPCS",					width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_NCSS_JUG_FEE",		index:"SRA_NCSS_JUG_FEE",			width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_PRNY_JUG_FEE",		index:"SRA_PRNY_JUG_FEE",			width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_MDCCS",				index:"SRA_MDCCS",					width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_INJT_FEE",			index:"SRA_INJT_FEE",				width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_SHNM",				index:"SRA_SHNM",					width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_PDG_RC_FEE",		index:"SRA_PDG_RC_FEE",				width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_RMHN_FEE",			index:"SRA_RMHN_FEE",				width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_TRU_FEE",			index:"SRA_TRU_FEE",				width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_FED_SPY_AM",		index:"SRA_FED_SPY_AM",				width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"TD_RC_CST",				index:"TD_RC_CST",					width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"MT12_OVR_FEE",			index:"MT12_OVR_FEE",				width:120, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	...
	function fn_CreateGrid_12(data){
	    ...
	    var searchResultColModel = [
	                                 ...
	                                 {name:"SRA_NCSS_JUG_FEE",           index:"SRA_NCSS_JUG_FEE",         width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_PRNY_JUG_FEE",           index:"SRA_PRNY_JUG_FEE",         width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_MDCCS",                  index:"SRA_MDCCS",                width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"SRA_INJT_FEE",               index:"SRA_INJT_FEE",             width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}},
	                                 {name:"FEE_SAM",                    index:"FEE_SAM",                  width:65, align:'right', formatter:'integer', formatoptions:{decimalPlaces:0,thousandsSeparator:','}}
	                               ];
