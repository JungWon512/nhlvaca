...
//        $( "#auc_dt"   ).datepicker().datepicker("setDate", fn_getToday());
    ...
    function fn_CreateGrid(data){              
        ...
        if(data != null){
        	...
        	var searchResultColNames = ["경매일자", "경매대상", "등록구분", "성별", "출장두수", "두수", "유찰두수", "전체(kg)", "평균(kg)", "총 예정가", "예정가<br>평균금액(A)", "총 낙찰가<br>금액", "낙찰가<br>평균금액(B)", "비고(평균차액)<br>(B-A)", "최고가", "최저가"
        								];        
        ...
        var ftot_lows_sbid_lmt_am = 0; //총 예정가(A)
        var ftot_avg_pr           = 0; //예정가<br>평균금액( 
        ...
        var mtot_lows_sbid_lmt_am = 0; //총 예정가           
        var mtot_avg_pr           = 0; //예정가<br>평균금액(A)
        ...
        var tot_lows_sbid_lmt_am = 0; //총 예정가           
        var tot_avg_pr           = 0; //예정가<br>평균금액(A)
