...
//         $("#grd_HdnMhSogCow").jqGrid("clearGridData", true);
	...
	function fn_BtnAdj_fm_print(p_param, p_grid) {
		...
		if (($("#prto_tpc_1").is(":checked"))) {
			...
			* 청주 : 8808990658995 , 장성 : 8808990817675 , 해남 : 8808990656106, 고흥 : 8808990779546
			...
			*/
				...
				|| na_bzplc == '8808990658995' || na_bzplc == '8808990817675' || na_bzplc == '8808990656106' || na_bzplc == '8808990779546'
