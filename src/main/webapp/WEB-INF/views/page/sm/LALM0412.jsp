...
//         $("#grd_HdnMhSogCow").jqGrid("clearGridData", true);
	...
	function fn_CreateGrd_MhSogCow(data){
	    ...
	    var searchResultColModel = [
	                                 ...
	                                 {name:"SRA_SBID_AM",           index:"SRA_SBID_AM",           width:40, align:'right', formatter:'integer', formatoptions:{thousandsSeparator:',', decimalPlaces: 0}},
	                                 {name:"SRA_TR_FEE",            index:"SRA_TR_FEE",            width:40, align:'center', formatter:'integer', formatoptions:{thousandsSeparator:',', decimalPlaces: 0}},
...
//				ReportPopup('LALM0412R0_1_5',p_param, p_grid, 'V');
			...
			// 영주:8808990687094
				...
				p_param.title = "일반가축경매(" + $('auc_obj_dsc').val() +")개별정산서 제"+$('#auc_dt').val() +"차";
 ...
 //   				ReportPopup('LALM0412R0_5_4',p_param, p_grid, 'V');
		...
		function fn_BtnDbtCnf(){
	        ...
	        TitleData.acno = parent.wmcList[0].ACNO;
		 	...
		 	}else if(na_bzplc ==  '8808990643625') {  // 진주 : 8808990657240
