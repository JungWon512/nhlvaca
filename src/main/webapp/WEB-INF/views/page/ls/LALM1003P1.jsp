...
<script type="text/javascript">
        ...
        $("#pb_ReceiptReport").on('click',function(e){
            ...
            if(App_na_bzplc == '8808990657622' ){// 홍성: 8808990657622 테스트: 8808990643625
    	        ...
    	        if($('#auc_obj_dsc').val() == '1'){
                	ReportPopupTemp('LALM1003R1_2',TitleData, uniqueObject,tmpObject, 'H');//V:가로 , H:세로
    	        }else{
                	ReportPopupTemp('LALM1003R1_2_1',TitleData, uniqueObject,tmpObject, 'H');//V:가로 , H:세로    	        	
    	        }
            	//ReportPopup('LALM1003R1_2',TitleData, tmpObject, 'H');//V:가로 , H:세로
            }else {
            	ReportPopup('LALM1003R1_1',TitleData, tmpObject, 'H');//V:가로 , H:세로
            }            
    ...
    function fn_Search(){ 
    	 $("#grd_CowBun").jqGrid("clearGridData", true);
        //정합성체크        
        var results = sendAjaxFrm("frm_Search", "/LALM1003P1_selList", "POST");        
        var result;
