    ...
    $(document).ready(function(){
        ...
        $("#pb_ListReport").on('click',function(e){
            ...
            if($('#ppgcow_fee_dsc').val() == '1'){
            	ReportPopup('LALM1003R4_1',TitleData, 'grd_CowBun', 'H');//V:가로 , H:세로
            }else {
            	ReportPopup('LALM1003R4_2',TitleData, 'grd_CowBun', 'H');//V:가로 , H:세로
            }
        });
        ...
        $("#pb_ConfirmReport").on('click',function(e){
			...
			if(App_na_bzplc == ''){
	            ReportPopup('LALM1003R4_3_1',TitleData, tmpObject, 'H');//V:가로 , H:세로				
			}else{
	            ReportPopup('LALM1003R4_3',TitleData, tmpObject, 'H');//V:가로 , H:세로				
			}         
        });
    	 ...
    	 MessagePopup('YESNO',"저장 하시겠습니까?",function(res){
             if(res){
                 ...
                 if(tmpSaveObject.length > 0) {
                     ...
                     result = sendAjax(insDataObj, "/LALM1003P4_updCowBun", "POST");
