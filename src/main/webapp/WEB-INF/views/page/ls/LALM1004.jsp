						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td>
										<input type="text" class="integer" id="cow_sog_wt" maxlength="8" />
									</td>
									<th scope="row"><span>50kg 이상</span></th>
									<td>
										<input type="text" class="number" id="re_product_1" maxlength="2" value="0" disabled />
									</td>
									<th scope="row"><span>20kg 이상</span></th>
									<td>
										<input type="text" class="number" id="re_product_2" maxlength="2" value="0" disabled />
									</td>
									<th scope="row"><span>20kg 미만</span></th>
									<td>
										<input type="text" class="number" id="re_product_3" maxlength="2" value="0" disabled />
									</td>
