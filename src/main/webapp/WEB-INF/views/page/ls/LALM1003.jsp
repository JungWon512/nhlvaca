...
//         $("#pb_ExcelUpload").hide();
         ...
         $("#pb_CntnDel").on('click',function(e){
             ...
             MessagePopup('YESNO',"삭제하시겠습니까?",function(res){
                 if(res){
                     ...
                     var results = sendAjaxFrm("frm_Search", "/LALM1003_delCntnDel", "POST");        
                     var result;
         ...
         ******************************/
         $("#pb_CowReport").on('click',function(e){
             ...
             if(App_na_bzplc == '8808990656557'){
                 ReportPopup('LALM1003R0_0',TitleData, gridData, 'V');//V:가로 , H:세로            	 
             }else{
                 ReportPopup('LALM1003R0',TitleData, gridData, 'V');//V:가로 , H:세로            	 
             }
         });
         ...
         $("#pb_AllDel").on('click',function(e){
             ...
             MessagePopup('YESNO',"삭제하시겠습니까?",function(res){
                 if(res){
                     ...
                     var results = sendAjaxFrm("frm_Search", "/LALM1003_delSogCow", "POST");        
                     var result;
         ...
         $("#pb_SbidCancelReport").on('click',function(e){
             ...
             if(App_na_bzplc == '8808990656588'){
                 ...
                 if($("#auc_obj_dsc").val() == '3'){
                     ReportPopup('LALM1003R0_2',TitleData, 'grd_MhSogCow', 'V');//V:가로 , H:세로
                 }else {
                     ReportPopup('LALM1003R0_1',TitleData, 'grd_MhSogCow', 'V');//V:가로 , H:세로
                 }
             }
         });
        ...
        $("#pb_FeeReset").on('click',function(e){
            ...
            var nowFeeSum = 0;
            //계산전수수료합계조회
            var result_feeImps = sendAjaxFrm("frm_Search", "/LALM1003_selFeeImps", "POST");        
            var feeImps;
            ...
            var results = sendAjaxFrm("frm_Search", "/LALM1003_insFeeReset", "POST");        
            var result;
            ...
            if(results.status != RETURN_SUCCESS){
            	...
            	//계산후ㅜ수료합계조회
            	var result_feeImps2 = sendAjaxFrm("frm_Search", "/LALM1003_selFeeImps", "POST");
            	var feeImps2;
    ...
    function fn_Search(){                
        ...
        var results = sendAjaxFrm("frm_Search", "/LALM1003_selList", "POST");        
        var result;
    ...
    function fn_CreateGrid(data){
        ...
        $("#grd_MhSogCow").jqGrid({
            ...
            onSelectRow: function(rowid, status, e){
                ...
                var Results = sendAjax(data, "/LALM1003_selCalfList", "POST");
                var Result;
                if(Results.status != RETURN_SUCCESS){
