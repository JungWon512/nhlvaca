...
@Service
public class LALM1003P1ServiceImpl implements LALM1003P1Service {

	private static Logger log = LoggerFactory.getLogger(LALM1003P1ServiceImpl.class);

	@Autowired
	private LogService logService;
	@Autowired
	LALM1003P1Mapper lalm1003p3Mapper;
	...
	public Map<String, Object> LALM1003P1_insEtc(Map<String, Object> inMap) throws Exception {
		...
		for (Map<String, Object> map : list) {
			...
			insertNum += lalm1003p3Mapper.LALM1003P1_insEtc(map);

			map.put("chg_pgid", "LALM1003P1");
			map.put("chg_rmk_cntn", "출장내역 일괄등록");
			insertNum += logService.insSogCowLog(map);

			insertNum += lalm1003p3Mapper.LALM1003P1_insIndv(map);
	...
	@Override
	@SuppressWarnings("unchecked")
	public Map<String, Object> LALM1003P1_selEtcVaild(Map<String, Object> inMap) throws Exception {
		Map<String, Object> reMap = new HashMap<String, Object>();
		List<Map<String, Object>> list = (List<Map<String, Object>>) inMap.get("list");
