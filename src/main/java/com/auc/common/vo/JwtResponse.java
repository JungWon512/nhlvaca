...
public class JwtResponse implements Serializable{
    ...
    public JwtResponse(String jwttoken, int status, String key, String iv, String userId, String eno, String na_bzplc, String security, String na_bzplnm, String usrnm, String grp_c, String strg_dt) {
        this.jwttoken  = jwttoken;
        this.status    = status;
        this.key       = key;
        this.iv        = iv;
